...
export const ABOUT: Dict = {
  ...
  "team.eyebrowGovernance": { EN: "Governance", BN: "পরিচালনা" },
  "team.eyebrowGuidance": { EN: "Guidance", BN: "দিকনির্দেশনা" },
  "team.eyebrowLeadership": { EN: "Leadership", BN: "নেতৃত্ব" },
  "team.eyebrowOperations": { EN: "Operations", BN: "কার্যক্রম পরিচালনা" },
