...
export const DONATE: Dict = {
  ...
  "donate.selectProject": { EN: "Select a project or purpose…", BN: "একটি প্রকল্প বা উদ্দেশ্য বেছে নিন…" },
  "donate.otherOption": { EN: "Other — Zakat, Sadakah, or general fund", BN: "অন্যান্য — যাকাত, সদকা বা সাধারণ তহবিল" },
  ...
  "donate.err.target": { EN: "Please choose a project or 'Other'.", BN: "অনুগ্রহ করে একটি প্রকল্প বা 'অন্যান্য' বেছে নিন।" },
  "donate.err.purpose": {
    EN: "Please say what your donation is for (e.g. Zakat, Sadakah).",
    BN: "অনুগ্রহ করে লিখুন অনুদানটি কীসের জন্য (যেমন: যাকাত, সদকা)।",
  },
  ...
  // Payment methods
  "donate.paymentEyebrow": { EN: "Payment Methods", BN: "পেমেন্ট পদ্ধতি" },
  "donate.paymentHeading": { EN: "Pay Securely via SSLCommerz", BN: "SSLCommerz-এর মাধ্যমে নিরাপদে পেমেন্ট করুন" },
  "donate.paymentBody": {
    EN: "All donations are processed through SSLCommerz — Bangladesh's leading payment gateway. Your payment is encrypted and secure.",
    BN: "সব অনুদান বাংলাদেশের শীর্ষস্থানীয় পেমেন্ট গেটওয়ে SSLCommerz-এর মাধ্যমে প্রক্রিয়া করা হয়। আপনার পেমেন্ট এনক্রিপ্টেড ও নিরাপদ।",
  },
  "donate.card": { EN: "Debit / Credit Card", BN: "ডেবিট / ক্রেডিট কার্ড" },
  "donate.cardSub": { EN: "All major banks", BN: "সব প্রধান ব্যাংক" },
  "donate.cardBody": {
    ...
    BN: "যেকোনো ভিসা, মাস্টারকার্ড বা দেশীয় ব্যাংকের ডেবিট কার্ড দিয়ে পেমেন্ট করুন। আপনার কার্ডের তথ্য সরাসরি SSLCommerz সামলায়—আমরা তা কখনো দেখি না।",
  },
  "donate.mobile": { EN: "Mobile Banking", BN: "মোবাইল ব্যাংকিং" },
  "donate.mobileSub": { EN: "bKash · Nagad · Rocket", BN: "বিকাশ · নগদ · রকেট" },
  "donate.internet": { EN: "Internet Banking", BN: "ইন্টারনেট ব্যাংকিং" },
  "donate.internetSub": { EN: "50+ banks supported", BN: "৫০টিরও বেশি ব্যাংক" },
  "donate.internetBody": {
  ...
  "donate.zakatGatewayLead": { EN: "Giving Zakat through the gateway?", BN: "গেটওয়ের মাধ্যমে যাকাত দিচ্ছেন?" },
  "donate.zakatGatewayBody": {
    EN: "Choose \"Other\" in the form above and write \"যাকাত\" as the purpose.",
    BN: "ওপরের ফর্মে \"অন্যান্য\" বেছে নিন এবং উদ্দেশ্যের ঘরে \"যাকাত\" লিখুন।",
  },
  ...
  "donate.directBody": {
    EN: "Prefer to give without the gateway? Send your contribution straight to our bank account or mobile banking number below.",
    BN: "গেটওয়ে ছাড়া দিতে চান? নিচের ব্যাংক অ্যাকাউন্ট বা মোবাইল ব্যাংকিং নম্বরে সরাসরি আপনার অবদান পাঠান।",
  },
  "donate.bankTransfer": { EN: "Bank Transfer", BN: "ব্যাংক ট্রান্সফার" },
  "donate.bankName": { EN: "Islami Bank Bangladesh", BN: "ইসলামী ব্যাংক বাংলাদেশ" },
