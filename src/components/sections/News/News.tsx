...
const NewsCardSkeleton = ({ large = false }: { large?: boolean }) => (
  <div className={`animate-pulse rounded-2xl overflow-hidden bg-gray-200 dark:bg-gray-800 ${large ? "h-56 sm:h-96 md:h-[450px] lg:h-[520px]" : "h-48 sm:h-64 lg:h-[252px]"}`} />
)
