...
import { ArrowRight, Sparkles, GraduationCap, Heart, School, UserCheck } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 2xl:max-w-[1600px] 3xl:max-w-[1800px] 4xl:max-w-[2000px]">
      ...
      >
        ...
        >
          Student Square provides counselling, advocacy, and community programs to help students and families thrive in
