...
export default function Footer() {
  ...
  const year = lang === "BN" ? new Intl.NumberFormat("bn-BD", { useGrouping: false }).format(currentYear) : currentYear

  const links = {
    // Every href here must be a real route — FAQ, Resources and Accessibility
    ...
    resources: [
      ...
      { key: "footer.stories", href: "/blog/real-life-stories" },
      ...
      <div className="container px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20 w-full max-w-7xl mx-auto 2xl:max-w-[1600px] 3xl:max-w-[1800px] 4xl:max-w-[2000px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-12 sm:mb-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-sm font-bold uppercase tracking-wider text-foreground mb-6">{t("quickLinks")}</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-sm font-bold uppercase tracking-wider text-foreground mb-6">{t("resources")}</h3>
            <ul className="space-y-3">
        ...
        >
          <div className="flex flex-col items-center gap-4">
            <span className="text-sm font-medium text-muted-foreground">{t("followUs")}</span>
            <div className="flex items-center gap-3">
              {socials.map((social) => (
                <a
                  ...
                  aria-label={social.name === "Email" ? t("footer.email") : social.name}
