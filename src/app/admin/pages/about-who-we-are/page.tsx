...
const SLUG = "about-who-we-are" as const;

export default function WhoWeAreEditorPage() {
  ...
  return (
    <div className="max-w-3xl 2xl:max-w-6xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-foreground tracking-tight">Who We Are</h1>
