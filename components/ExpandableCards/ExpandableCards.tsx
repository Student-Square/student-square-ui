...
import { BookOpen, Briefcase, GraduationCap, HeartHandshake } from "lucide-react"
...
const cardsData = [
  ...
  },
  {
    ...
    icon: Briefcase,
    buttonHoverClass: "hover:bg-orange-500/70 hover:border-orange-300/80",
    ...
    <section className="relative w-full px-4 py-10 sm:px-6 sm:py-12 md:px-8 md:py-16">
      <div className="container relative z-10 mx-auto w-full max-w-7xl 2xl:max-w-[1600px] 3xl:max-w-[1800px] 4xl:max-w-[2000px]">
        <div className="p-2 sm:p-3 md:p-4">
          ...
          <motion.div
            className="flex flex-col gap-4 md:min-h-[500px] md:flex-row md:gap-5 lg:min-h-[560px]"
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0">
                    ...
                    />
                    <div className={cn("absolute inset-0 mix-blend-multiply", card.tintClass)} />
                    <div className="absolute inset-0 bg-gradient-to-b from-black/25 via-black/15 to-black/72" />
                    <div className="absolute inset-0 ring-1 ring-inset ring-white/10" />
                  </div>

                  {/* Content */}
                  <div className="relative z-10 flex h-full flex-col justify-between p-4 sm:p-5 md:p-7">
                    <h3 className="max-w-[13ch] whitespace-pre-line font-heading text-2xl font-semibold leading-[1.05] text-white sm:text-3xl md:text-[2.2rem]">
                      {card.title}
                    </h3>
